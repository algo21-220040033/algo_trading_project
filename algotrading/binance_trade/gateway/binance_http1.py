...
class BinanceHttp(object):
    ...
    def __init__(self, key=None, secret=None, host=None, timeout=5):
        ...
        self.host = host if host else "https://api.binancezh.cc"
    ...
    def get_mytrade(self,symbol,start_time=None,end_time=None,limit=1000):
        path='/api/v3/myTrades'
        query_dict = {"symbol": symbol, "timestamp": self._timestamp(),"limit":limit}
        if start_time:
            query_dict['startTime']=start_time
        if end_time:
            query_dict['endTime']=end_time
    ...
    def get_all_order(self,symbol,start_time=None,end_time=None,limit=1000):
    ...
    def buy_bianbao(self,productId,amount):
    ...
    def sell_bianbao(self,productId,amount,type:B_type):
